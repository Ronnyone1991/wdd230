const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=6eaafa6a5e118a5a4624a2623c1868e4";
fetch(apiURL)
...
const forecastURL =
  "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=6eaafa6a5e118a5a4624a2623c1868e4";
fetch(forecastURL)
  .then((response) => response.json())
  .then((jsObject) => {
    console.log(jsObject);
...
// Display the new events list of Soda Spring
